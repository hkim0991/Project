...
if (!testing){train_rows <- 40000000  # if testing is False and there is !> !+False => True
skip_rows_train <- total_rows - train_rows
test_rows <- -1L # this means it will read all the rows in test data
} else {
...
fwrite(sub, "lgb_Usrnewness1.csv")
