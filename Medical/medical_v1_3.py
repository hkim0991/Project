...
- creatinine (normal: 0.8~1.7, max=98 ????) ## to check
- sgot_ast (normal: 0~40 IU/L, max=999 ???)
- sgpt_alt (normal: 0~40 IU/L, max=999 ???)
- gamma_gtp (normal: male - 11~63IU/L, female- 8~35IU/Lm, max= 999 ???)
