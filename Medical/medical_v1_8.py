...
medi1 = medi1[medi1['sight_left'].notnull()]  ##  select only the data which is not null.
medi1 = medi1[medi1['sight_right'].notnull()]
medi1 = medi1[medi1['hear_left'].notnull()]
medi1 = medi1[medi1['hear_right'].notnull()]
...
## predict missing values in ldl_chole from regression analysis 
## step1. make a seperate dataset with and without the missing value : train and test dataset
## step2. drop the missing data to make a train/validation dataset

## df['name of variable'].dropna(axis=0 -> row, axis=1 => column)

## step1
medi3 = medi2.dropna(axis=0)
medi3.isnull().sum()

## step2
from sklearn.model_selection import train_test_split
train_set, valid_set = train_test_split(medi3, test_size = 0.3)
